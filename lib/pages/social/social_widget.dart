                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'Hi. Lincoln are you available for a coffee chat next week ..',
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .bodySmall
                                                            .override(
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'Hi, Lincoln  we are pleased to offer you an opportunity for a 30 minutes interview with our ..... ',
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .bodySmall
                                                            .override(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          24.0, 20.0, 24.0, 0.0),
                                      child: Text(
                                        'Congratulations on completing your course! This is a significant achievement and a testament to your hard work, dedication, and commitment to personal growth and development. You should be proud of all that you have accomplished and the knowledge and skills you have gained. I wish you all the best as you move forward with your newfound expertise and pursue your dreams and goals. Well done!',
                                        textAlign: TextAlign.justify,
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
